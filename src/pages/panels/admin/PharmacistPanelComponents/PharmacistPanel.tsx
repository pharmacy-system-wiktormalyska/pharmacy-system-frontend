...
import {AddPharmacistPopover} from "./AddPharmacistPopover.tsx";
import {UpdatePharmacistPopover} from "./UpdatePharmacistPopover.tsx";
import {RemovePharmacistPopover} from "./RemovePharmacistPopover.tsx";
...
export const PharmacistPanel = () => {
    ...
    const showAddPopover = () => {
        showPopover(<AddPharmacistPopover/>)
        setSelectedRow(null)
    }

    const showUpdatePopover = () => {
        if (selectedRow !== null) {
            showPopover(<UpdatePharmacistPopover managerResponse={selectedRow}/>)
            setSelectedRow(null)
        }
    }
    const showRemovePopover = () => {
        if (selectedRow !== null) {
            showPopover(RemovePharmacistPopover())
            setSelectedRow(null)
        }
    }
