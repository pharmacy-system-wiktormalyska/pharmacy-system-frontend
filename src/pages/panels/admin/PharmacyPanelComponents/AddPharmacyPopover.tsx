...
import { useAddPharmacy } from "../../../../connection/hooks/usePharmacy.tsx";
import { StyledTable } from "../../../../components/StyledTable.tsx";

interface AddPharmacyPopoverProps {
    onActionComplete: () => void;
}

export const AddPharmacyPopover = ({ onActionComplete }: AddPharmacyPopoverProps) => {
    ...
    const { mutate: addPharmacy, isSuccess } = useAddPharmacy();
    const { hidePopover } = usePopover();

    const SubmitPharmacy = () => {
        if (name && address && type && owner && phone && email && website) {
            ...
            if (isSuccess) alert("Successfully updated pharmacy!");
            onActionComplete();
            hidePopover();
        }
    };
